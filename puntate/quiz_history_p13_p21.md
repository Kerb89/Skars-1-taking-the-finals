# Quizzone — Storico domande (parte 2: P13-P21)
...
### quiz_puntata21_misto.md — 6 luglio 2026
1. 🖼️ Bandiera drago bianco giallo arancione paese (Bhutan) → C
2. Allenatore Milan Champions 2007 dopo Istanbul (Carlo Ancelotti) → A
3. Anno pubblicazione postuma "Il maestro e Margherita" Bulgakov (1967) → C
4. Figura retorica vita a oggetto inanimato senza persona (Animazione) → B
5. 🖼️ Corrente artistica Gauguin "Ia Orana Maria" (Post-Impressionismo) → B
6. Nazione eliminò Brasile ottavi Mondiale 2026 Haaland (Norvegia) → C
7. Spagnolo tempo verbale azioni abituali passato (Pretérito imperfecto) → A
8. Proprietà tra due razionali ne esiste sempre un altro (Densità) → D
9. Indovinello Tom macellaio cosa pesa (Carne) → C
10. Paese africano lago Turkana deserto (Kenya) → B
11. Regista "Magnolia" e "There Will Be Blood" (Paul Thomas Anderson) → A
12. Processo biologico yogurt kefir crauti (Fermentazione lattica) → B
13. Compositore italiano "Nabucco" "Aida" Risorgimento (Giuseppe Verdi) → D
14. Inglese "to kick the bucket" significato (Morire) → B
15. Battaglia 1805 Napoleone Austria Russia tre imperatori (Austerlitz) → C
16. Pittore spagnolo "Las Meninas" Prado (Diego Velázquez) → D
17. Paese asiatico accordo UE maggio 2026 AI semiconduttori (Giappone) → A
18. Velocista giamaicano record 200m 19,19s (Usain Bolt) → C
19. Regista "Apocalypse Now" trilogia "Il Padrino" (Francis Ford Coppola) → D
20. Successione somma dei due precedenti 0 e 1 (Fibonacci) → A
21. Paese sudamericano capitale Asunción (Paraguay) → C
22. Nazionale battuto Messico 3-2 ottavi Mondiale 2026 Bellingham (Inghilterra) → B
23. Condimento fermentato thai umami pad thai (Salsa di pesce) → D
24. Anagramma CONVERSAZIONE (Conservazione) → C
25. Vittoria militare 1066 Guglielmo Conquistatore trono inglese (Hastings) → B
26. Attore Travis Bickle "Taxi Driver" 1976 (Robert De Niro) → A
27. Inglese "it's raining cats and dogs" significato (Pioggia intensa) → D
28. Fenomeno geologico placche convergono una sotto l'altra (Subduzione) → A
29. Ciclista belga 5 Tour 5 Giri "il Cannibale" (Eddy Merckx) → B
30. Decade XX secolo transistor Bell Labs (Anni Quaranta) → C
31. Scrittore russo "Guerra e pace" "Anna Karenina" (Lev Tolstoj) → D
32. Artista rinascimentale "Scuola di Atene" Vaticano (Raffaello Sanzio) → D
33. Lingua origine "magazzino" da "makhāzin" (Arabo) → B
34. Indovinello quante volte sottrarre 5 da 25 (Una sola volta) → C
35. Struttura orecchio interno equilibrio accelerazione (Apparato vestibolare) → D
36. Regista spagnolo Leone d'Oro Venezia 2024 "The Room Next Door" (Pedro Almodóvar) → B
37. Espressione "botte piena moglie ubriaca" tipologia (Proverbio) → A
38. Anno prima traversata Manica a nuoto (1875) → A
39. Album Kendrick Lamar 2017 Pulitzer "HUMBLE." "DNA." (DAMN.) → D
40. Tecnica cottura giapponese piastra rovente commensali (Teppanyaki) → C
41. Sport termine "ace" servizio vincente (Tennis) → B
42. Filosofo tedesco "Critica della ragion pura" 1781 (Immanuel Kant) → A
43. Invenzione 1876 Bell trasmissione voce distanza (Telefono) → B
44. Portoghese brasiliano "cafuné" gesto (Passare dita tra capelli) → D
45. Regista giapponese "Kikujiro" "Hana-bi" Leone d'Oro 1997 (Takeshi Kitano) → B
