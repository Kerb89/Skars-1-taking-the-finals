# Quizzone — Storico domande

Questo file traccia tutte le domande usate nei quiz generati, per evitare ripetizioni.
...
4. Pallone d'Oro 2025 (Dembélé) → C
5. Protocollo Kyoto entrata in vigore (2005) → C
6. Umami e acido glutammico → B
7. Oscar 2026 Miglior Film (One Battle After Another, PTA) → B
8. log₂(1024) = 10 → C
9. Sagra della Primavera (Stravinskij) → C
10. Mulholland Drive + Inland Empire (David Lynch) → B
11. Cent'anni di solitudine famiglia (Buendía) → A
12. Guernica bombardamento (guerra civile spagnola) → B
13. Prosopopea/personificazione → C
14. Schadenfreude (Deutsch) → B
15. Personification (English) → B
16. Capitale Burkina Faso (Ouagadougou) → C
17. Scheduler CPU → B
18. Ossa scheletro adulto (206) → B
19. PSG-Inter Champions League 2025 (5-0) → C
20. Pearl Harbor anno (1941) → C
21. Fermentazione lattica ATP (2) → A
22. Numero primo più grande tra 91/93/97/99 (97) → A
23. Nobel Letteratura 2025 (Krasznahorkai) → B
24. TCP livello trasporto → C
25. Foce del Nilo (Egitto) → C
26. Alien 1979 → B
27. Colesterolo buono (HDL) → B
28. Conditionnel passé deuxième forme (français) → D
...
4. Roland Garros maschile 2026 (Zverev) → D
5. Pietà vaticana autore (Michelangelo) → A
6. Minerale più duro scala Mohs (Diamante) → B
7. Velocità della luce nel vuoto esatta (299.792.458 m/s) → A [ESTREMO]
8. 15² − 8² = 161 → A
9. Nona Sinfonia Beethoven prima esecuzione (1824) → A
10. Scrittore "Il processo" e "La metamorfosi" (Kafka) → B
11. Film 1994 Tarantino cheeseburger (Pulp Fiction) → C
12. Stretto Bosforo Europa-Asia (Bosforo) → C
13. Passato remoto "cuocere" prima persona (cossi) → C
14. Wanderlust significato tedesco (desiderio di viaggiare) → A
15. Frase grammaticalmente corretta inglese (They have been waiting...) → B
16. Deserto Atacama paese (Cile) → D
17. SQL combinare tabelle (JOIN) → B
18. Organo produce bile (Fegato) → B
19. Italia medaglie Milano-Cortina 2026 (30) → A
20. Trattato 1648 Guerra Trent'anni (Pace di Vestfalia) → C
21. Fungo fermentazione miso (Aspergillus oryzae/koji) → D
22. Somma primi 15 numeri naturali (120) → C
23. Nobel Pace 2025 (María Corina Machado) → D
24. Antonelli età prima vittoria F1 (19) → C
25. Numero di Avogadro valore (6,022 × 10²³) → A
26. Cantautore "La cura" 1996 (Battiato) → B
27. Computer 2001 Odissea nello spazio (HAL 9000) → C
28. Significato "éphémère" francese (di breve durata) → C
...
### Puntata 3
| # | Artista | Canzone | Tipo | File |
|---|---------|---------|------|------|
| 10 | Rosa Chemical ft. Bdope | Polka 3 | audio | canzone4_clean.txt |
| 20 | M83 | Midnight City | audio | canzone5_clean.txt |
| 27 | Foster The People | Pumped Up Kicks | audio | canzone6_clean.txt |
| 9 | Queen | Bohemian Rhapsody | testo brano | — |
