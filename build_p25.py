"""Build script for Quizzone Puntata 25 - Misto. No audio. 1 image (Cezanne)."""
...
QUIZ_MD = os.path.join(BASE, "puntate", "quiz_puntata25_misto.md")
OUTPUT = os.path.join(BASE, "puntate", "quiz_puntata25_misto.html")

IMG_FILES = {
    2: os.path.join(BASE, "art_questions_images", "da_usare", "cezanne_mont_sainte_victoire.jpg"),
}
...
CAT_BG_MAP = {
    "anagrammi": os.path.join(CAT_BG_DIR, "anagrammi.jpg"),
    ...
    "dituttounpo": os.path.join(CAT_BG_DIR, "dituttounpo.jpg"),
...
CATEGORIES = {
    ...
    6:"cibo", 7:"lingue", 8:"musica", 9:"cinema", 10:"matematica",
    11:"letteratura", 12:"lingua_italiana", 13:"inglese", 14:"tecnologia",
    15:"anagrammi", 16:"geografia", 17:"tecnologia", 18:"scienze",
    19:"sport", 20:"indovinelli", 21:"storia", 22:"cibo", 23:"cinema",
    24:"matematica", 25:"musica", 26:"dituttounpo", 27:"lingue",
    28:"arte", 29:"letteratura", 30:"geografia", 31:"inglese",
    32:"sport", 33:"geografia", 34:"sport", 35:"scienze", 36:"storia",
    37:"anagrammi", 38:"attualita", 39:"dituttounpo", 40:"cinema",
    41:"dituttounpo", 42:"tecnologia", 43:"letteratura", 44:"lingua_italiana",
    45:"lingue",
}

ANSWERS = {
    1:1, 2:3, 3:0, 4:2, 5:1, 6:3, 7:0, 8:2, 9:1, 10:3,
    11:0, 12:2, 13:1, 14:3, 15:0, 16:2, 17:1, 18:0, 19:3, 20:2,
    21:1, 22:0, 23:3, 24:2, 25:0, 26:1, 27:3, 28:2, 29:0, 30:1,
    31:1, 32:2, 33:0, 34:1, 35:3, 36:2, 37:0, 38:1, 39:3, 40:2,
    41:0, 42:1, 43:3, 44:2, 45:1,
}
...
def main():
    print("=== Building Quizzone Puntata 25 ===")
    ...
    html = template
    html = html.replace("{{PUNTATA_TITLE}}", "Puntata 25 \u2014 Misto")
    html = html.replace("{{SUBTITLE}}", "Misto \u2014 45 domande \u2014 20s timer")
    html = html.replace("{{FILENAME}}", "quiz_puntata25_misto")
