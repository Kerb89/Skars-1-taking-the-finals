...
### quiz_2026-06-20_misto — Jacopo
- **Punteggio:** 2.647 punti
- **Corrette:** 21/30 (70%)
- **Tempo medio:** 6.6s
- **Corrette:** 1, 3, 4, 5, 6, 7, 8, 10, 11, 13, 14, 15, 16, 18, 20, 21, 23, 26, 27, 28, 30
- **Sbagliate:** 2, 9, 12, 17, 19, 22, 24, 25, 29
- **Contestazioni:** nessuna

#### Dettaglio risposte:
| # | Tempo | Risposta | Corretta | Punti |
|---|-------|----------|----------|-------|
| 1 | 5.9s | C ✓ | C | +221 |
| 2 | 8.1s | B ✗ | A | -75 |
| 3 | 8.4s | D ✓ | D | +188 |
...
### quiz_puntata3_misto — Jacopo
- **Punteggio:** 2.692 punti (stimato dalle risposte)
- **Corrette:** 21/35 (60%)
- **Tempo medio:** ~6.5s
- **Sbagliate:** 9, 10, 11, 13, 14, 17, 18, 20, 21, 24, 25, 27, 32
- **Contestazioni:** nessuna

#### Errori dettaglio:
| # | Domanda (tema) | Risposta data | Corretta | Note |
|---|----------------|---------------|----------|------|
| 9 | Testo "Bohemian Rhapsody" (Queen) | C | A | Musica — testo brano |
| 10 | 🎵 Rosa Chemical — Polka 3 | B (Polka 2) | C (Polka 3) | Musica — audio |
| 11 | Film Pixar 2009 palloncini (Up) | D | B | Cinema |
| 13 | Anafora (figura retorica) | C (Chiasmo) | D (Anafora) | Lingua italiana |
| 14 | Fernweh tedesco (impulso di viaggiare) | C (Paura di volare) | A | Lingue straniere |
| 17 | Git merge (unire branch) | B (git join) | A (git merge) | Tecnologia |
| 18 | Milza (filtra sangue) | C (Appendice) | A (Milza) | Scienze |
| 20 | 🎵 M83 — Midnight City | A (MGMT) | D (M83) | Musica — audio |
| 21 | Umami — glutammato | A (Saccarosio) | B (Glutammato) | Scienze |
| 24 | Eurovision 2026 Vienna | C (Zurigo) | D (Vienna) | Attualità |
| 25 | Parete cellulare (cellule vegetali) | B (Citoscheletro) | C | Scienze |
| 27 | 🎵 Foster The People — Pumped Up Kicks | C (Helena Beat) | A | Musica — audio |
| 32 | Saturno lune (140+) | B (Giove) | A (Saturno) | Scienze |

#### Commento di Jacopo:
> "Domande musicali tutte scazzate — ma nessuna per quanto mi riguarda parlava di musica. Anche quelle su giochini e merda varia le ho sbagliate, o beccate a culo. L'unica che potevo fare era l'anafora e il francese"

#### Pattern errori:
- **Musica (audio): 3/3 sbagliate** — non riconosce brani da spezzoni audio
